...
class NewEdenMap_Iface a where
  ...
  closestCelestial :: a -> NewEden_Types.Coordinate -> P.IO NewEden_Types.Celestial
  distance :: a -> NewEden_Types.Celestial -> NewEden_Types.Coordinate -> P.IO P.Double
